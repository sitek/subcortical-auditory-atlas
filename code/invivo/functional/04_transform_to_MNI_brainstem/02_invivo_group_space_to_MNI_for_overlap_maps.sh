...
# This script is used to transform maps with integer values. For example number
# of overlapping subjects map.

# Invivo group average image that will be transformed to MNI
IMAGE="/path/to/invivo_group_map_with_integer_precision.nii.gz"
...
command="c3d "
command+="-interpolation NearestNeighbor "
